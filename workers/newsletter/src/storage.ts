...
export async function unsubscribeByToken(
  ...
  await db.batch([
    ...
    db
      .prepare(
        "INSERT OR IGNORE INTO newsletter_suppressions (email, subscriber_id, reason, provider, created_at, metadata) VALUES (?, ?, 'user_unsubscribe', 'first_party', ?, '{}')",
      )
