      ...
      render: (row) => {
        ...
        return (
          <RowTitle
            ...
            // A name two Macs share carries its host in words, beside the
            // device tile too, which alone is too small to tell them apart.
...
export function ActivityView({ data }: { data: OpsData }) {
  ...
  // host included, or a reader route's.
