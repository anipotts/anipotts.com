...
/**
 * operations theme — built by `pnpm exec astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { operationsTheme } from './operations';
...
export const operationsTheme = {
  ...
  tokens: {
    ...
    "--color-accent": "light-dark(#286c65, #8ac8bd)",
    "--color-accent-muted": "light-dark(#e8f1ee, #223b36)",
    ...
    "--color-on-accent": "light-dark(#ffffff, #152d28)",
  ...
  components: {
    ...
    "app-shell": {
      "base": {
        "--color-workspace-sidebar": "light-dark(#f1f6f4, #131b19)"
      }
    },
    "top-nav": {
      "base": {
